        ...
        return (
          <SwiperSlide key={index}>
            <div className="h-max bg-black/10 rounded-lg px-4 pt-4 mr-4 pb-0 flex sm:flex-col gap-x-6 sm:gap-x-0 group cursor-pointer hover:bg-black/20 transition-all duration-300">
              ...
              {/* title & desc */}
              <div className="mb-8 ">
                <div className="mb-2 text-blue-600 font-mono font-bold">
                  {item.time1} {""}
                  <span className="max-w-[350px] ml-2 mr-0 font-normal leading-normal text-black font-sora">
                    {item.description1}
                  </span>
                </div>
                ...
                <div className="mb-2 text-blue-600 font-mono font-bold">
                  {item.time2} {""}
                  <span className="max-w-[350px] ml-2 font-sora font-normal leading-normal text-black">
                    {item.description2}
                  </span>
                </div>
                <div className="mb-2 text-blue-600 font-mono font-bold">
                  {item.time3} {""}
                  <span className="max-w-[350px] font-sora ml-2 font-normal leading-normal text-black">
                    {item.description3}
                  </span>
                </div>
              </div>
